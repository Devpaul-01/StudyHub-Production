...
def google_callback():
    ...
    try:
        if not google.authorized:
            return redirect(url_for("student.student_auth.register") + "?error=oauth_failed")
        ...
        session["google_email"] = google_info.get("email")
        session["google_name"] = google_info.get("name")
